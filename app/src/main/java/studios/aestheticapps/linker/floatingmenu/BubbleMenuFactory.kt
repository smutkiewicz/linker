...
{
    fun createMenu(context: Context, callback: BubbleContentCallback): BubbleMenu
    {
        val demoMenu = LinkedHashMap<String, Content>()
        demoMenu[BubbleMenu.BROWSE_ITEMS_TAB] = BrowseItemsBubbleContent(context, callback)
